...
Source0  : https://www.apache.org/dist/apr/apr-util-1.6.2.tar.gz
Source1  : https://www.apache.org/dist/apr/apr-util-1.6.2.tar.gz.asc
...
%prep
%setup -q -n apr-util-1.6.2-rc3
cd %{_builddir}/apr-util-1.6.2-rc3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675182035
...
cp %{_builddir}/apr-util-%{version}-rc3/LICENSE %{buildroot}/usr/share/package-licenses/apr-util/8cd04ee1fde0cfe74a78fae4153a693cc795cc5c || :
%make_install
...
/usr/lib64/libaprutil-1.so.0.6.2
